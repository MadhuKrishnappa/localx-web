...
const FAQBox = ({ defaultOpen, title, content }) => {
  ...
  return (
    <div
      className="pt-2 sm:pt-6 pb-2 px-3 sm:px-8  rounded-3xl bg-bgDark3 main-border-gray-darker mb-4 relative hover:bg-bgDarkTransparentLighter cursor-pointer transition"
